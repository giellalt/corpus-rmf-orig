...
<xsl:variable name="filename" select="'http://www.regeringen.se/content/1/c6/13/78/64/bc1eeac0.pdf'"/>
...
<xsl:variable name="note" select="'Main url: http://www.regeringen.se/sb/d/108/a/137864'"/>
